...
!-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
   ...
   real(RLEN) :: O2o0, N1p0, N3n0, N4n0, O4n0, N5s0, N6r0, B1c0, B1n0, B1p0, &
    ...
    Z5n0, Z5p0, Z6c0, Z6n0, Z6p0, R1c0, R1n0, R1p0, R2c0, R2nc0, R2nn0, R2np0, &
    R2ns0, R3c0, R6c0, R6n0, R6p0, R6s0, O3c0, O3h0, O5c0
   ...
   namelist /bfm_init_nml/ O2o0, N1p0, N3n0, N4n0, O4n0, N5s0, N6r0, B1c0, &
    ...
    Z4p0, Z5c0, Z5n0, Z5p0, Z6c0, Z6n0, Z6p0, R1c0, R1n0, R1p0, R2c0, R2nc0, &
    R2nn0, R2np0, R2ns0, R3c0, R6c0, R6n0, R6p0, R6s0, O3c0, O3h0, O5c0
