...
R2nc => D3STATE(:,ppR2nc); R2nc=ZERO
R2nn => D3STATE(:,ppR2nn); R2nn=ZERO
R2np => D3STATE(:,ppR2np); R2np=ZERO
R2ns => D3STATE(:,ppR2ns); R2ns=ZERO
...
totsyss => D2DIAGNOS(:,pptotsyss); totsyss=ZERO
   ...
   PELSURFACE => D2DIAGNOS(:,14+1:14+55); PELSURFACE=ZERO
   ...
   jsurR2nc => D2DIAGNOS(:,14+ppR2nc); jsurR2nc=ZERO
   jsurR2nn => D2DIAGNOS(:,14+ppR2nn); jsurR2nn=ZERO
   jsurR2np => D2DIAGNOS(:,14+ppR2np); jsurR2np=ZERO
   jsurR2ns => D2DIAGNOS(:,14+ppR2ns); jsurR2ns=ZERO
   ...
   PELBOTTOM => D2DIAGNOS(:,69+1:69+55); PELBOTTOM=ZERO
   jbotO2o => D2DIAGNOS(:,69+ppO2o); jbotO2o=ZERO
   jbotN1p => D2DIAGNOS(:,69+ppN1p); jbotN1p=ZERO
   jbotN3n => D2DIAGNOS(:,69+ppN3n); jbotN3n=ZERO
   jbotN4n => D2DIAGNOS(:,69+ppN4n); jbotN4n=ZERO
   jbotO4n => D2DIAGNOS(:,69+ppO4n); jbotO4n=ZERO
   jbotN5s => D2DIAGNOS(:,69+ppN5s); jbotN5s=ZERO
   jbotN6r => D2DIAGNOS(:,69+ppN6r); jbotN6r=ZERO
   jbotB1c => D2DIAGNOS(:,69+ppB1c); jbotB1c=ZERO
   jbotB1n => D2DIAGNOS(:,69+ppB1n); jbotB1n=ZERO
   jbotB1p => D2DIAGNOS(:,69+ppB1p); jbotB1p=ZERO
   jbotP1c => D2DIAGNOS(:,69+ppP1c); jbotP1c=ZERO
   jbotP1n => D2DIAGNOS(:,69+ppP1n); jbotP1n=ZERO
   jbotP1p => D2DIAGNOS(:,69+ppP1p); jbotP1p=ZERO
   jbotP1l => D2DIAGNOS(:,69+ppP1l); jbotP1l=ZERO
   jbotP1s => D2DIAGNOS(:,69+ppP1s); jbotP1s=ZERO
   jbotP2c => D2DIAGNOS(:,69+ppP2c); jbotP2c=ZERO
   jbotP2n => D2DIAGNOS(:,69+ppP2n); jbotP2n=ZERO
   jbotP2p => D2DIAGNOS(:,69+ppP2p); jbotP2p=ZERO
   jbotP2l => D2DIAGNOS(:,69+ppP2l); jbotP2l=ZERO
   jbotP3c => D2DIAGNOS(:,69+ppP3c); jbotP3c=ZERO
   jbotP3n => D2DIAGNOS(:,69+ppP3n); jbotP3n=ZERO
   jbotP3p => D2DIAGNOS(:,69+ppP3p); jbotP3p=ZERO
   jbotP3l => D2DIAGNOS(:,69+ppP3l); jbotP3l=ZERO
   jbotP4c => D2DIAGNOS(:,69+ppP4c); jbotP4c=ZERO
   jbotP4n => D2DIAGNOS(:,69+ppP4n); jbotP4n=ZERO
   jbotP4p => D2DIAGNOS(:,69+ppP4p); jbotP4p=ZERO
   jbotP4l => D2DIAGNOS(:,69+ppP4l); jbotP4l=ZERO
   jbotZ3c => D2DIAGNOS(:,69+ppZ3c); jbotZ3c=ZERO
   jbotZ3n => D2DIAGNOS(:,69+ppZ3n); jbotZ3n=ZERO
   jbotZ3p => D2DIAGNOS(:,69+ppZ3p); jbotZ3p=ZERO
   jbotZ4c => D2DIAGNOS(:,69+ppZ4c); jbotZ4c=ZERO
   jbotZ4n => D2DIAGNOS(:,69+ppZ4n); jbotZ4n=ZERO
   jbotZ4p => D2DIAGNOS(:,69+ppZ4p); jbotZ4p=ZERO
   jbotZ5c => D2DIAGNOS(:,69+ppZ5c); jbotZ5c=ZERO
   jbotZ5n => D2DIAGNOS(:,69+ppZ5n); jbotZ5n=ZERO
   jbotZ5p => D2DIAGNOS(:,69+ppZ5p); jbotZ5p=ZERO
   jbotZ6c => D2DIAGNOS(:,69+ppZ6c); jbotZ6c=ZERO
   jbotZ6n => D2DIAGNOS(:,69+ppZ6n); jbotZ6n=ZERO
   jbotZ6p => D2DIAGNOS(:,69+ppZ6p); jbotZ6p=ZERO
   jbotR1c => D2DIAGNOS(:,69+ppR1c); jbotR1c=ZERO
   jbotR1n => D2DIAGNOS(:,69+ppR1n); jbotR1n=ZERO
   jbotR1p => D2DIAGNOS(:,69+ppR1p); jbotR1p=ZERO
   jbotR2c => D2DIAGNOS(:,69+ppR2c); jbotR2c=ZERO
   jbotR2nc => D2DIAGNOS(:,69+ppR2nc); jbotR2nc=ZERO
   jbotR2nn => D2DIAGNOS(:,69+ppR2nn); jbotR2nn=ZERO
   jbotR2np => D2DIAGNOS(:,69+ppR2np); jbotR2np=ZERO
   jbotR2ns => D2DIAGNOS(:,69+ppR2ns); jbotR2ns=ZERO
   jbotR3c => D2DIAGNOS(:,69+ppR3c); jbotR3c=ZERO
   jbotR6c => D2DIAGNOS(:,69+ppR6c); jbotR6c=ZERO
   jbotR6n => D2DIAGNOS(:,69+ppR6n); jbotR6n=ZERO
   jbotR6p => D2DIAGNOS(:,69+ppR6p); jbotR6p=ZERO
   jbotR6s => D2DIAGNOS(:,69+ppR6s); jbotR6s=ZERO
   jbotO3c => D2DIAGNOS(:,69+ppO3c); jbotO3c=ZERO
   jbotO3h => D2DIAGNOS(:,69+ppO3h); jbotO3h=ZERO
   jbotO5c => D2DIAGNOS(:,69+ppO5c); jbotO5c=ZERO
