...
!       R2nc                       Semi-labile Dissolved Organic Nitrogen         mg C/m3
!       R2nn                       Semi-labile Dissolved Organic Nitrogen       mmol N/m3
!       R2np                       Semi-labile Dissolved Organic Nitrogen       mmol P/m3
!       R2ns                       Semi-labile Dissolved Organic Nitrogen      mmol Si/m3
...
!        O5c                                                      Calcite         mg C/m3
        ...
        integer,parameter,public  ::NO_D3_BOX_STATES   = 55

        integer,parameter,public  ::NO_D3_BOX_DIAGNOSS = 102

        integer,parameter,public  ::NO_D2_BOX_DIAGNOSS = 124
    ...
    ppR2c=43, ppR2n=0, ppR2p=0, ppR2s=0, ppR2nc=44, ppR2nn=45, ppR2np=46, &
    ppR2ns=47, ppR3c=48, ppR3n=0, ppR3p=0, ppR3s=0, ppR6c=49, ppR6n=50, &
    ppR6p=51, ppR6s=52, ppO3c=53, ppO3h=54, ppO5c=55, ppO5h=0
   ...
   real(RLEN),public,dimension(:),pointer  :: O2o, N1p, N3n, N4n, O4n, N5s, &
    ...
    Z6c, Z6n, Z6p, R1c, R1n, R1p, R2c, R2nc, R2nn, R2np, R2ns, R3c, R6c, R6n, &
    R6p, R6s, O3c, O3h, O5c
   ...
   real(RLEN),public,dimension(:),pointer  :: Q1c, Q1n, Q1p, Q11c, Q11n, &
    ...
    iiLastElement=6
        ...
        integer,parameter,public :: iiPelDetritus=5, iiR1=1, iiR2=2, iiR2n=3, iiR3=4, iiR6=5
...
! qpcOMT(iiR2n)                       Semi-labile Dissolved Organic Nitrogen     mmol N/mg C
...
! qncOMT(iiR2n)                       Semi-labile Dissolved Organic Nitrogen     mmol P/mg C
...
! qscOMT(iiR2n)                       Semi-labile Dissolved Organic Nitrogen    mmol Si/mg C
...
! qscBOM(iiQ16)                     Deep Sediment Particulate organic Matter    mmol Si/mg C
   ...
   real(RLEN),public,dimension(:),pointer  :: totbenc, totbenn, totbenp, &
    ...
    jsurR2nc, jsurR2nn, jsurR2np, jsurR2ns, jsurR3c, jsurR6c, jsurR6n, jsurR6p, &
    jsurR6s, jsurO3c, jsurO3h, jsurO5c
    ...
    jbotR2nc, jbotR2nn, jbotR2np, jbotR2ns, jbotR3c, jbotR6c, jbotR6n, jbotR6p, &
    jbotR6s, jbotO3c, jbotO3h, jbotO5c
   ...
   function ppPelDetritus(n,constituent)
     ...
     integer,dimension(5 * iiLastElement ) :: pointers = (/ & 
             ppR1c ,ppR1n ,ppR1p ,0     ,0     ,0     , &
          ppR2c ,0     ,0     ,0     ,0     ,0     , &
          ppR2nc ,ppR2nn ,ppR2np ,0     ,ppR2ns ,0     , &
          ppR3c ,0     ,0     ,0     ,0     ,0     , &
