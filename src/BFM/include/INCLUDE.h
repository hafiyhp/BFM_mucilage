...
#define R2nc(A) D3STATE(A,ppR2nc)
#define R2nn(A) D3STATE(A,ppR2nn)
#define R2np(A) D3STATE(A,ppR2np)
#define R2ns(A) D3STATE(A,ppR2ns)
...
#define jsurR2nc(B) D2DIAGNOS(B,14+ppR2nc)
#define jsurR2nn(B) D2DIAGNOS(B,14+ppR2nn)
#define jsurR2np(B) D2DIAGNOS(B,14+ppR2np)
#define jsurR2ns(B) D2DIAGNOS(B,14+ppR2ns)
...
#define PELBOTTOM(A,B) D2DIAGNOS(A,69+B)
#define jbotO2o(B) D2DIAGNOS(B,69+ppO2o)
#define jbotN1p(B) D2DIAGNOS(B,69+ppN1p)
#define jbotN3n(B) D2DIAGNOS(B,69+ppN3n)
#define jbotN4n(B) D2DIAGNOS(B,69+ppN4n)
#define jbotO4n(B) D2DIAGNOS(B,69+ppO4n)
#define jbotN5s(B) D2DIAGNOS(B,69+ppN5s)
#define jbotN6r(B) D2DIAGNOS(B,69+ppN6r)
#define jbotB1c(B) D2DIAGNOS(B,69+ppB1c)
#define jbotB1n(B) D2DIAGNOS(B,69+ppB1n)
#define jbotB1p(B) D2DIAGNOS(B,69+ppB1p)
#define jbotP1c(B) D2DIAGNOS(B,69+ppP1c)
#define jbotP1n(B) D2DIAGNOS(B,69+ppP1n)
#define jbotP1p(B) D2DIAGNOS(B,69+ppP1p)
#define jbotP1l(B) D2DIAGNOS(B,69+ppP1l)
#define jbotP1s(B) D2DIAGNOS(B,69+ppP1s)
#define jbotP2c(B) D2DIAGNOS(B,69+ppP2c)
#define jbotP2n(B) D2DIAGNOS(B,69+ppP2n)
#define jbotP2p(B) D2DIAGNOS(B,69+ppP2p)
#define jbotP2l(B) D2DIAGNOS(B,69+ppP2l)
#define jbotP3c(B) D2DIAGNOS(B,69+ppP3c)
#define jbotP3n(B) D2DIAGNOS(B,69+ppP3n)
#define jbotP3p(B) D2DIAGNOS(B,69+ppP3p)
#define jbotP3l(B) D2DIAGNOS(B,69+ppP3l)
#define jbotP4c(B) D2DIAGNOS(B,69+ppP4c)
#define jbotP4n(B) D2DIAGNOS(B,69+ppP4n)
#define jbotP4p(B) D2DIAGNOS(B,69+ppP4p)
#define jbotP4l(B) D2DIAGNOS(B,69+ppP4l)
#define jbotZ3c(B) D2DIAGNOS(B,69+ppZ3c)
#define jbotZ3n(B) D2DIAGNOS(B,69+ppZ3n)
#define jbotZ3p(B) D2DIAGNOS(B,69+ppZ3p)
#define jbotZ4c(B) D2DIAGNOS(B,69+ppZ4c)
#define jbotZ4n(B) D2DIAGNOS(B,69+ppZ4n)
#define jbotZ4p(B) D2DIAGNOS(B,69+ppZ4p)
#define jbotZ5c(B) D2DIAGNOS(B,69+ppZ5c)
#define jbotZ5n(B) D2DIAGNOS(B,69+ppZ5n)
#define jbotZ5p(B) D2DIAGNOS(B,69+ppZ5p)
#define jbotZ6c(B) D2DIAGNOS(B,69+ppZ6c)
#define jbotZ6n(B) D2DIAGNOS(B,69+ppZ6n)
#define jbotZ6p(B) D2DIAGNOS(B,69+ppZ6p)
#define jbotR1c(B) D2DIAGNOS(B,69+ppR1c)
#define jbotR1n(B) D2DIAGNOS(B,69+ppR1n)
#define jbotR1p(B) D2DIAGNOS(B,69+ppR1p)
#define jbotR2c(B) D2DIAGNOS(B,69+ppR2c)
#define jbotR2nc(B) D2DIAGNOS(B,69+ppR2nc)
#define jbotR2nn(B) D2DIAGNOS(B,69+ppR2nn)
#define jbotR2np(B) D2DIAGNOS(B,69+ppR2np)
#define jbotR2ns(B) D2DIAGNOS(B,69+ppR2ns)
#define jbotR3c(B) D2DIAGNOS(B,69+ppR3c)
#define jbotR6c(B) D2DIAGNOS(B,69+ppR6c)
#define jbotR6n(B) D2DIAGNOS(B,69+ppR6n)
#define jbotR6p(B) D2DIAGNOS(B,69+ppR6p)
#define jbotR6s(B) D2DIAGNOS(B,69+ppR6s)
#define jbotO3c(B) D2DIAGNOS(B,69+ppO3c)
#define jbotO3h(B) D2DIAGNOS(B,69+ppO3h)
#define jbotO5c(B) D2DIAGNOS(B,69+ppO5c)
...
#define jrivR2nc(B) D2DIAGNOS(B,0+ppR2nc)
#define jrivR2nn(B) D2DIAGNOS(B,0+ppR2nn)
#define jrivR2np(B) D2DIAGNOS(B,0+ppR2np)
#define jrivR2ns(B) D2DIAGNOS(B,0+ppR2ns)
